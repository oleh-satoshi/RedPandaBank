...
@Component
public class InlineScheduleAddAgainEventTimeAndDayButton implements Pressable {
    final TranslateService translateService;
    static final String ADD_ANOTHER_DAY_AND_TIME = "add-another-day-and-time";
    static final String DONE = "done";

    public InlineScheduleAddAgainEventTimeAndDayButton(TranslateService translateService) {
    ...
    public InlineKeyboardMarkup getKeyboard() {
        return InlineKeyboardMarkupBuilderImpl.create()
                .button(translateService.getBySlug(ADD_ANOTHER_DAY_AND_TIME),
                        Commands.SAVE_EVENT_DAY.getName())

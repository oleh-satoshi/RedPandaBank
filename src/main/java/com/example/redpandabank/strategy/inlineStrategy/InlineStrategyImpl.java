...
import com.example.redpandabank.strategy.inlineStrategy.scheduleInline.InlineEditSpecificEventDay;
...
import com.example.redpandabank.strategy.inlineStrategy.scheduleInline.InlineScheduleSaveSpecificEventDay;
import com.example.redpandabank.strategy.inlineStrategy.scheduleInline.InlineScheduleSetExtraDayForSpecificEvent;
...
public class InlineStrategyImpl implements InlineStrategy {
    ...
    public InlineStrategyImpl(LessonService lessonService,
        ...
        strategyMap.put(Commands.EDIT_EVENT_DAY.getName(),
                new InlineEditSpecificEventDay(lessonService, lessonScheduleService,
                        messageSender, translateService));
